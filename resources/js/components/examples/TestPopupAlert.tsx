...
export function TestPopupAlert() {
    ...
    return (
        <div className="space-y-4 p-8">
            <h2 className="mb-6 text-2xl font-bold">Test Popup Alerts</h2>
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
                ...
                <Button
                    onClick={() =>
                        showDeleted('Deleted!', 'This item has been deleted.')
                    }
            ...
            <div className="mt-8">
                <Button
                    onClick={() => {
                        showSuccess(
                            'Test Alert',
                            'If you see this, the popup alerts are working!',
                        );
                    }}
                    variant="outline"
                >
