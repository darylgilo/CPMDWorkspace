                        ...
                        <div className="flex h-14 items-center justify-between sm:h-16">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-bold text-gray-900 sm:text-base lg:text-xl dark:text-white">
                                    ...
                                    <span className="hidden sm:inline">CROP PEST MANAGEMENT DIVISION</span>
                                </span>
                            </div>
                            ...
                            <nav className="flex items-center gap-1.5 sm:gap-2">
                                ...
                                {auth.user ? (
                                    ...
                                    <>
                                        ...
                                        <Link
                                            href={register()}
                                            className="rounded-lg bg-[#163832] px-4 py-2 text-xs font-semibold text-white shadow-md transition-all hover:bg-[#163832]/90 md:w-auto dark:bg-[#235347] dark:hover:bg-[#235347]/90 hover:text-white hover:shadow-lg sm:px-6 sm:py-2.5 sm:text-sm"
                                        >
                                            Sign up
                                        </Link>
                                    </>
                    ...
                    <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
                        ...
                        <div className="space-y-6 lg:space-y-8">
                            <div className="space-y-3 lg:space-y-4">
                                <h1 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl xl:text-6xl dark:text-white">
                                    CPMD Workspace
                                </h1>
                                <p className="text-base leading-relaxed text-gray-600 sm:text-lg dark:text-gray-300">
                                    a streamlined, all-in-one web platform designed to help teams plan, manage, and deliver projects with clarity and efficiency. Built for modern workflows, brings together communication, project tracking, document organization, and decision-making tools into a single intuitive environment.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
                                <Link
                                    ...
                                    className="rounded-lg bg-[#163832] px-6 py-3 text-center text-sm font-semibold text-white shadow-lg transition-all hover:bg-[#163832]/90 md:w-auto dark:bg-[#235347] dark:hover:bg-[#235347]/90 hover:text-white hover:shadow-xl sm:px-8 sm:py-3.5 sm:text-base"
                                >
                                    Sign up
                                </Link>
                                <a
                        ...
                        <div className="relative flex items-center justify-center">
                            <img
                                src={isDark ? "/images/hero-image2.png" : "/images/hero-image.png"}
