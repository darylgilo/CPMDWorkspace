...
export default function EmployeeView() {
  ...
  interface FormData {
    ...
    office: 'DO' | 'ADO' | 'CPMD' | 'AED' | 'NSQCS' | 'NPQSD' | 'NSIC' | 'CRPSD' | 'PPSSD' | 'ADMINISTRATIVE' | 'Others';
    cpmd: '' | 'BIOCON section' | 'PFS section' | 'PHPS SECTION' | 'OC-Admin Support Unit' | 'OC-ICT Unit' | 'OC-Special Project' | 'Others';
    tin_number: string;
    gsis_number: string;
    address: string;
  ...
  const initialData: FormData = {
    ...
    employment_status: (user?.employment_status || 'Regular') as FormData['employment_status'],
  ...
  return (
    <AppLayout breadcrumbs={[
      ...
      { title: user?.name || 'Employee', href: `/employees/${user?.id}` },
    ]}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input id="email" value={data.email} onChange={(e) => setData('email', e.target.value)} className="mt-1" />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <select id="employment_status" value={data.employment_status} onChange={(e) => setData('employment_status', e.target.value as FormData['employment_status'])} className="mt-1 block w-full border border-input rounded px-3 py-2 bg-background text-foreground">
                    ...
                    {data.employment_status === 'Regular' && (
                      <div>
                        ...
                        <Input id="item_number" value={data.item_number} onChange={(e) => setData('item_number', e.target.value)} className="mt-1" />
                      </div>
                    )}
                    <div>
                      <Label htmlFor="office">Office</Label>
                      <select id="office" value={data.office} onChange={(e) => {
                        const val = e.target.value as FormData['office'];
                        setData('office', val);
                        if (val !== 'CPMD') {
                          setData('cpmd', 'Others' as FormData['cpmd']);
                        }
                    ...
                    {data.office === 'CPMD' && (
                      <div>
                        ...
                        <select id="cpmd" value={data.cpmd} onChange={(e) => setData('cpmd', e.target.value as FormData['cpmd'])} className="mt-1 block w-full border border-input rounded px-3 py-2 bg-background text-foreground">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input id="hiring_date" type="date" value={data.hiring_date} onChange={(e) => setData('hiring_date', e.target.value)} className="mt-1" />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="gsis_number" value={data.gsis_number} onChange={(e) => setData('gsis_number', e.target.value)} className="mt-1" />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <select id="gender" value={data.gender} onChange={(e) => setData('gender', e.target.value as FormData['gender'])} className="mt-1 block w-full border border-input rounded px-3 py-2 bg-background text-foreground">
                    ...
                    <div>
                      ...
                      <Input id="mobile_number" value={data.mobile_number} onChange={(e) => setData('mobile_number', e.target.value)} className="mt-1" />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input id="contact_number" value={data.contact_number} onChange={(e) => setData('contact_number', e.target.value)} className="mt-1" />
                    </div>
                  </div>
                </div>
              </div>
