...
import { UserPlus, Eye, RotateCcw } from 'lucide-react';
              ...
              <CustomCard key={employee.id}>
                ...
                <CustomCardContent>
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <span className={`text-xs px-2 py-0.5 rounded-full ${employee.status === 'active' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-gray-100 text-gray-700 dark:bg-neutral-700 dark:text-gray-300'}`}>
                      {employee.status || '—'}
                    </span>
                    <button
