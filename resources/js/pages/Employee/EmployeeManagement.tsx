      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <form onSubmit={handleSearch} className="flex-1 flex flex-col md:flex-row md:items-center gap-2 md:gap-3">
            ...
            <button type="submit" className="px-4 py-2 rounded bg-[#163832] hover:bg-[#163832]/90 text-white dark:bg-[#235347] dark:hover:bg-[#235347]/90">Search</button>
            {/* Filters */}
            <div className="flex items-center gap-2 md:ml-2">
              <select
                className="border rounded px-3 py-2 bg-white text-gray-900 dark:bg-neutral-800 dark:text-gray-100 dark:border-neutral-600"
                value={office}
                onChange={(e) => {
              ...
              <select
                className="border rounded px-3 py-2 bg-white text-gray-900 dark:bg-neutral-800 dark:text-gray-100 dark:border-neutral-600 disabled:opacity-60"
                value={cpmd}
              ...
              <button
                ...
                className="px-3 py-2 rounded border bg-white hover:bg-gray-50 text-gray-900 border-gray-300 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-gray-100 dark:border-neutral-600"
              >
                Clear
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4">
          {Array.isArray(users?.data) && users.data.length > 0 ? (
            users.data.map((u: any) => (
              <div key={u.id} className="bg-white dark:bg-neutral-900 rounded-lg border border-gray-200 dark:border-neutral-800 p-4 flex gap-3">
