...
import { Calendar as CalendarIcon, Clock, User, FileText, ChevronLeft, ChevronRight, Search, Calendar } from 'lucide-react';
      ...
      <div className="flex h-full flex-1 flex-col gap-6 overflow-x-hidden p-4">
        ...
        <div className="rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-neutral-900">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Notice of Meeting</h1>
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                {selectedDate
                  ? `Showing meetings for ${selectedDate.toLocaleDateString('en-US', {
                      month: 'long',
                      day: 'numeric',
                      year: 'numeric',
                    })}`
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Search meetings by title or user..."
            ...
            <div className="sticky top-4 rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-neutral-900">
              ...
              <div className="grid grid-cols-7 gap-1">
                ...
                {calendarDays.map((day, index) => {
                  ...
                  const meetingCount = getAnnouncementCount(day);
                  ...
                  return (
                    <button
                      ...
                      className={`
                        relative flex h-12 flex-col items-center justify-center rounded-md p-1 text-sm transition
                        ${isToday ? 'font-bold ring-2 ring-[#163832] dark:ring-[#235347]' : ''}
                        ${isSelected ? 'bg-[#163832] text-white dark:bg-[#235347]' : ''}
                        ${!isSelected && hasMeetings ? 'bg-blue-50 font-medium text-blue-900 dark:bg-blue-900/20 dark:text-blue-300' : ''}
                        ${!isSelected && !hasMeetings ? 'hover:bg-gray-100 dark:hover:bg-neutral-800' : ''}
                        ${!isSelected && hasMeetings ? 'hover:bg-blue-100 dark:hover:bg-blue-900/30' : ''}
                      `}
                    >
