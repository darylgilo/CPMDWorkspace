...
import { Calendar as CalendarIcon, Clock, User, FileText, ChevronLeft, ChevronRight, Search, Bell } from 'lucide-react';
      ...
      <div className="flex h-full flex-1 flex-col gap-6 overflow-x-hidden p-4">
        ...
        <div className="rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-neutral-900">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Notice of Events</h1>
            ...
            <div className="sticky top-4 rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-neutral-900">
              ...
              <div className="grid grid-cols-7 gap-1">
                ...
                {calendarDays.map((day, index) => {
                  ...
                  const eventCount = getAnnouncementCount(day);
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${!isSelected && hasEvents ? 'bg-blue-50 font-medium text-blue-900 dark:bg-blue-900/20 dark:text-blue-300' : ''}
                        ${!isSelected && !hasEvents ? 'hover:bg-gray-100 dark:hover:bg-neutral-800' : ''}
                        ${!isSelected && hasEvents ? 'hover:bg-blue-100 dark:hover:bg-blue-900/30' : ''}
                      `}
                    >
