...
export default function AnnouncementPage() {
    ...
    function openEditDialog(notice: any) {
                                ...
                                {calendarDays.map((day, index) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`relative flex h-12 flex-col items-center justify-center rounded-md p-1 text-sm transition ${isToday ? 'font-bold ring-2 ring-[#163832] dark:ring-[#235347]' : ''} ${isSelected ? 'bg-[#163832] text-white dark:bg-[#235347]' : ''} ${!isSelected && hasEventsOnDay ? 'bg-blue-50 font-medium text-blue-900 dark:bg-blue-800/40 dark:text-blue-200' : ''} ${!isSelected && !hasEventsOnDay ? 'hover:bg-gray-100 dark:hover:bg-neutral-800' : ''} ${!isSelected && hasEventsOnDay ? 'hover:bg-blue-100 dark:hover:bg-blue-800/60' : ''} `}
                                        >
